...
//   const [lentItemsList, setLendItemsList] = useState([])

//   useEffect(() => {
//     if (users) {
//         setLendItemsList(user.lentItems);
//     }
//   }, [users]);
    ...
    <main className="main">
      ...
      users?.map((user: IUserLendItem) =>(
        ...
        <AccordionSummary
          ...
          id="panel1a-header"
        >
        <img className='profilePicAccordion' src="../../images/Profile Img.jpg" alt="Profile-pic" />
